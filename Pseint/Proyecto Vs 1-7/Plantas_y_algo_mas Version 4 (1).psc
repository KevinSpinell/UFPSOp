Algoritmo sin_titulo
	...
	Definir ca_du, ca_cl, ca_ca, ca_da, ca_je, ca_pa, ca_ma, ca_pi, ca_or, V, C, T, AD, ADMIN Como Entero;
		...
		Segun AD Hacer
			1:
				...
				Mientras RES = Verdadero Hacer
					...
					Leer OP;
					si OP = "Si" o OP == 'si' o OP == 'SI' o OP == 'sI' Entonces
						RES = Verdadero;
					Sino 
						si OP = "no" o OP = "No" o OP = "nO" o OP = "NO" Entonces
							RES = Falso;
						Sino
							Escribir "Por favor responda si o no, lo tomare como un SI, se repetira el proceso";
						Finsi
					FinSi
				FinMientras
				RES = Falso;
